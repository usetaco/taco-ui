...
var TextField = function (_a) {
    var _b = _a.type, type = _b === void 0 ? 'text' : _b, label = _a.label, desc = _a.desc, placeholder = _a.placeholder, value = _a.value, setValue = _a.setValue, _c = _a.disabled, disabled = _c === void 0 ? false : _c;
    return (React.createElement(react_1.FormControl, null,
        React.createElement(react_1.Flex, { direction: "column", gap: "8px" },
            ...
            React.createElement(react_1.Input, { type: type, name: label, id: label, value: value || '', onChange: function (e) {
