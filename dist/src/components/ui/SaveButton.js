...
var SaveButton = function (_a) {
    ...
    return (React.createElement(react_1.Button, { backgroundColor: "#00B012", type: "submit", color: "#ffff", fontWeight: 400, _hover: { backgroundColor: '#00B012', color: '#fff' }, onClick: onClick, isDisabled: disabled, isLoading: loading }, text));
};
